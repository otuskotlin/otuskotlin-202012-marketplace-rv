...
import ru.otus.otuskotlin.marketplace.rv.business.logic.backend.operations.stubs.WorkshopUpdateStub

object WorkshopUpdate: IOperation<MpBeContext> by pipeline( {
    execute(InitializePipeline)
    execute(QuerySetWorkMode)
    execute(WorkshopUpdateStub)
